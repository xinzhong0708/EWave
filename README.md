...
Template.xlsx file is an empty excel file where users can fill in to run their own sample. The only difference compared to the previous one is that this file has no data.
